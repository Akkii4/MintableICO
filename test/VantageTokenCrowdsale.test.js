...
const VantageTokenCrowdsale = artifacts.require('VantageTokenCrowdsale');
const RefundVault = artifacts.require('./RefundVault');
const TokenTimelock = artifacts.require('./TokenTimelock');

contract('VantageTokenCrowdsale', function([_, wallet, investor1, investor2, foundersFund, foundationFund, partnersFund]) {
  ...
  beforeEach(async function () {
    // Token config
    this.name = "VantageToken";
    this.symbol = "DAPP";
    this.decimals = 18;

    // Deploy Token
    this.token = await VantageToken.new(
      this.name,
      this.symbol,
      this.decimals
    );
    ...
    this.foundationPercentage = 20;
    this.partnersPercentage   = 10;

    this.crowdsale = await VantageTokenCrowdsale.new(
      this.rate,
      this.wallet,
      this.token.address,
      this.cap,
